(function($) {
    ...
    var methods = {
        init: function(options, function_filter_call_back) {
            ...
            $("#ui-tableFilter-menu button#ui-tableFilter-menu-unFilter").button({
                icons: {
                    primary: 'ui-icon-cancel'
                }
            }).addClass('ui-state-active').attr('disabled', 'disabled');
            $("#ui-tableFilter-menu button#ui-tableFilter-menu-sortAsc").button({
                icons: {
                    primary: 'ui-icon-circle-triangle-n'
                }
            });
            $("#ui-tableFilter-menu button#ui-tableFilter-menu-sortDesc").button({
                icons: {
        ...
        filter: function() {
            ...
            $("#ui-tableFilter-dialog").html(dialogHTML).dialog($.extend(methods.settings.dialog, {
                autoOpen: true,
